    ...
    const response = await axios.post(
      `${baseURL}/graphql`,
      {
        ...
        variables: {
          where: {
            schemaId: {
              equals: "0xa82ee781646e1f0556f79263109d442929977378fcb90b8ba7be4623a91964d7",
            },
            OR: [
              {
                attester: {
...
//   await getAttestationsForAddress("0xE8e19B4e6c00096F70dd9F55aa80AC49d493F448")
  ...
  return (
    <>
    <InnerPageContainer title="Organization Complete Attestation">
      {/* <h2>
            Verify with (Next.Id)
            </h2> */}
{/* 
      ...
      <table className="table ml-0 content-start" style={{ border: "1px solid"}}>
        <tr>
            <td>Attester</td>
            <td>Deadline</td>
            <td>Recipient</td>
